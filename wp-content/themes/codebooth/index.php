    ...
    <main class="main">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="block-banner">
                                <h2 class="heading-banner text-center wow animate__animated animate__fadeInUp">There Are
                                    98.688<br>Opportunities Here For you!</h2>
                                <div class="form-find mw-720 mt-80">
                                    <form class="wow animate__animated animate__fadeInUp">
                                        ...
                                        <button
                                            class="btn btn-default btn-find wow animate__animated animate__fadeInUp">Find
                                            now</button>
                                    </form>
                                </div>
        ...
        <section class="section-box mt-80">
            <div class="container">
                ...
                <div
                    class="text-normal text-center mb-60 color-black-5 box-mw-60 wow animate__animated animate__fadeInUp">
